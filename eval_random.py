...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Eval Random Agent (Random Actions)")
    ...
    logger.info(
        f"Starting evaluation on {total_episodes} scenarios using Random Policy (Random Actions)"
    )
