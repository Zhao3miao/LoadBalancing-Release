...
# Append parent directory to sys.path to ensure modules can be found
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Eval PPO Agent Online")
    ...
    agent_config = {
        ...
        "entropy_coef": 0.01,
        "initial_lr": 2.5e-4,
        "batch_size": 256,  # irrelevant for eval
        "num_minibatches": 4,  # irrelevant for eval
        "update_epochs": 4,  # irrelevant for eval
        "lr_decay": False,  # irrelevant for eval
        "num_updates": 1,  # irrelevant for eval
    }
