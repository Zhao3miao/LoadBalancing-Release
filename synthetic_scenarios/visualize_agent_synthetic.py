...
from common.train_offline_utils import normalize_obs
from env.cio_load_balancing_env import CIOLoadBalancingEnv
import numpy as np


def visualize_agent(model_path, scenario_path, save_anim_path=None):
    """
...
if __name__ == "__main__":
    ...
    # args.model_path = "./experiment1/results_sac+100/BS1_right_BS2_loiter_BS3_left"
    # args.scenario_path = "./scenarios/BS1_right_BS2_loiter_BS3_left/randomized_scenario_1.yaml"

    args.model_path = "./experiment1/results_sac+20+cf/BS1_right_BS3_left"
    args.scenario_path = "./scenarios/BS1_right_BS3_left/randomized_scenario_1.yaml"
    args.save_anim_path = "./visualizations/animation.gif"

    visualize_agent(args.model_path, args.scenario_path, save_anim_path=args.save_anim_path)